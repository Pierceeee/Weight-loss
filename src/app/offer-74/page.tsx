          ...
          <div className="p-8 pt-0 space-y-10">
            ...
            <div className="bg-purple-50/50 rounded-2xl p-6 border border-purple-100 space-y-4">
              ...
              <p className="text-xs text-slate-500 text-center leading-relaxed">
                We've automatically applied your {DISCOUNT_PERCENTAGE}% discount to the first subscription payment. Subscription renews automatically. Cancel anytime directly within the app.
              </p>
            </div>
