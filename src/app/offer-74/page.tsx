...
const DISCOUNT_PERCENTAGE = 74;

const PLANS = [
  { id: "7day", title: "7-day plan", original: 22.20, price: 5.77, daily: 0.82, featured: false },
  { id: "1month", title: "1-month plan", original: 44.40, price: 11.54, daily: 0.38, featured: false },
  { id: "3month", title: "3-month plan", original: 75.49, price: 19.63, daily: 0.22, featured: true, tag: "BEST VALUE" },
];
        ...
        <section className="bg-white rounded-3xl shadow-xl shadow-purple-200/20 overflow-hidden border border-purple-100">
          ...
          <div className="p-8 text-center bg-gradient-to-b from-purple-50/30 to-white">
            <div className="inline-block px-4 py-1 bg-purple-100 rounded-full text-purple-700 text-xs font-black uppercase mb-4">
              Limited Time: {DISCOUNT_PERCENTAGE}% OFF
            </div>
            ...
            <div className="bg-purple-50/50 rounded-2xl p-6 border border-purple-100 space-y-4">
              <div className="text-center">
                ...
                <p className="text-sm text-purple-600 font-medium">
                  ✅ {DISCOUNT_PERCENTAGE}% discount has been successfully applied
                </p>
              </div>
              ...
              <p className="text-xs text-slate-500 text-center leading-relaxed">
                We've automatically applied your {DISCOUNT_PERCENTAGE}% discount to the first subscription payment. Subscription renews automatically. Cancel anytime directly within the program.
              </p>
            </div>
