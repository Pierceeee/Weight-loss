...
export const femaleQuizQuestions: QuizQuestion[] = [
  {
    ...
    options: [
      { id: "18-27", label: "18-27", icon: "🌸", image: "/images/age-18-27.png" },
      { id: "27-40", label: "27-40", icon: "🌺", image: "/images/age-27-40.png" },
      { id: "41-50", label: "41-50", icon: "🌻", image: "/images/age-27-40.png" },
      { id: "50+", label: "50+", icon: "🌷", image: "/images/age-50-plus.png" },
    ],
    required: true,
  },
  {
